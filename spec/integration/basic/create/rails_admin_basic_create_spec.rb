...
describe 'MmoStarterKit Basic Create' do
  subject { page }
  ...
  describe 'create with has-one association' do
    before do
      ...
      @player = MmoStarterKit::AbstractModel.new('Player').all.to_a.last # first is created by FactoryGirl
    end
  ...
  describe 'create with has-many association' do
    before do
      ...
      @league = MmoStarterKit::AbstractModel.new('League').all.to_a.last
    end
  ...
  describe 'create with has-and-belongs-to-many association' do
    before do
      ...
      @fan = MmoStarterKit::AbstractModel.new('Fan').first
    end
