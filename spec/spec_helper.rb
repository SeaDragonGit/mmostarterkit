...
RSpec.configure do |config|
  ...
  config.include MmoStarterKit::Engine.routes.url_helpers
  ...
  config.before do
    ...
    MmoStarterKit::Config.reset
    MmoStarterKit::AbstractModel.reset
    MmoStarterKit::Config.audit_with(:history) if CI_ORM == :active_record
    MmoStarterKit::Config.yell_for_non_accessible_fields = false
  end
