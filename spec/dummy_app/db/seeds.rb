...
user_model     = MmoStarterKit::AbstractModel.new(User)
league_model   = MmoStarterKit::AbstractModel.new(League)
division_model = MmoStarterKit::AbstractModel.new(Division)
team_model     = MmoStarterKit::AbstractModel.new(Team)
