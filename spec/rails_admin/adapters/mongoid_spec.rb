...
describe 'MmoStarterKit::Adapters::Mongoid', mongoid: true do
  describe '#associations' do
    it 'returns Association class' do
      expect(MmoStarterKit::AbstractModel.new(Player).associations.first).
        to be_a_kind_of MmoStarterKit::Adapters::Mongoid::Association
    end
  end

  describe '#properties' do
    it 'returns Property class' do
      expect(MmoStarterKit::AbstractModel.new(Player).properties.first).
        to be_a_kind_of MmoStarterKit::Adapters::Mongoid::Property
    end
  end
  ...
  describe 'searching on association' do
    ...
    describe 'whose type is embedded has_many' do
      before do
        ...
        @abstract_model = MmoStarterKit::AbstractModel.new('FieldTest')
      end
  ...
  describe 'serialization' do
    before do
      @abstract_model = MmoStarterKit::AbstractModel.new('FieldTest')
      @controller = MmoStarterKit::MainController.new
    end
