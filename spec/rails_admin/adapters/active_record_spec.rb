...
describe 'MmoStarterKit::Adapters::ActiveRecord', active_record: true do
  before do
  ...
  describe '#associations' do
    it 'returns Association class' do
      expect(MmoStarterKit::AbstractModel.new(Player).associations.first).
        to be_a_kind_of MmoStarterKit::Adapters::ActiveRecord::Association
    end
  end
  ...
  describe '#properties' do
    it 'returns Property class' do
      expect(MmoStarterKit::AbstractModel.new(Player).properties.first).
        to be_a_kind_of MmoStarterKit::Adapters::ActiveRecord::Property
    end
  end
