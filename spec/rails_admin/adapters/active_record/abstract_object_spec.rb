...
describe 'MmoStarterKit::Adapters::ActiveRecord::AbstractObject', active_record: true do
  describe 'proxy' do
    let(:object) { double('object') }
    let(:abstract_object) { MmoStarterKit::Adapters::ActiveRecord::AbstractObject.new(object) }
  ...
  describe 'create' do
    ...
    let(:object) { MmoStarterKit::Adapters::ActiveRecord::AbstractObject.new player }
    ...
    describe 'a record with has_many associations' do
      ...
      let(:object) { MmoStarterKit::Adapters::ActiveRecord::AbstractObject.new league }
  ...
  describe 'object_label_method' do
    it 'is configurable' do
      ...
      expect(MmoStarterKit.config('League').with(object: @league).object_label).to eq("League '#{@league.name}'")
    end
  end
end
