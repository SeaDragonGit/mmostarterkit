namespace :mmo_starter_kit do
  desc "Install mmo_starter_kit"
  task :install do
    system 'rails g mmo_starter_kit:install'
  end

  desc "Uninstall mmo_starter_kit"
  task :uninstall do
    system 'rails g mmo_starter_kit:uninstall'
  end
